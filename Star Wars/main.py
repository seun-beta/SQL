...
attribute = 'people'
url = urllib.request.urlopen(service_url+attribute, 
                            context = ctx)
...
cur.execute('''CREATE TABLE StarWars(name, height, mass, hair_color, 
...
for person in data:
    ...
    cur.execute('''INSERT INTO StarWars(name, height, mass,
